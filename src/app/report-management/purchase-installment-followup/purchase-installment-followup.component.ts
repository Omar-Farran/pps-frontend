...
@Component({
  selector: 'app-purchase-installment-followup',
  templateUrl: './purchase-installment-followup.component.html',
  styleUrls: ['./purchase-installment-followup.component.scss']
})
export class PurchaseInstallmentFollowupComponent {
columns: any[] = [
    ...
    { name: "purchase-installment-followup-report.supplier", field: "customerName" },
...
branchies:any;
  ...
  private getList () 
  {
    this.baseService.Post('Report', 'GetPurchaseInstallmentsFollowUpReport', this.baseSearch).subscribe
    ( res => 
      {
...
downloadReport() {
  this.baseService.generatePDF('Report', 'GetPurchaseInstallmentFollowUpReportePDF', this.baseSearch)
    .subscribe((blob: Blob) => {
      debugger;
